  ...
  let list = items.map((item, index) => {
    ...
    return (
      <li key={index}>
        ...
        <Button variant="btn btn-outline-dark" size="small">
  ...
  return (
    <Container>
      <Row>
        ...
        <Col>
          <h2>Checkout:</h2>
          <Button variant="btn btn-outline-dark" onClick={checkOut}>Checkout ${finalList().total}</Button>
      ...
      <Row>
        ...
        >
          ...
          />
          <button id="restockBtn" class="btn btn-outline-dark" type="submit">Restock Products</button>
        </form>
      </Row>
    </Container>
  );
